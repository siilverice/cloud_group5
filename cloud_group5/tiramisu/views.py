...
def change_requirements(request):
	try:
		subprocess.check_call(['ls','../../Tiramisu/tiramisu_src/the_cube.py'])
	except:
...
def move(request):
	try:
		subprocess.check_call(['ls','../../Tiramisu/tiramisu_src/automated_move/move.py'])
	except:
		return HttpResponseRedirect("/tiramisu/servererror")
...
def createvm(request):
	try:
		subprocess.check_call(['ls','../../Tiramisu/tiramisu_src/init_vm/init_vm_for_user.py'])
	except:
		return HttpResponseRedirect("/tiramisu/servererror")
...
def shutdown(request):
	...
	try:
		subprocess.check_call(['sudo','virsh','list'])
	except:
		return HttpResponseRedirect("/tiramisu/servererror")

	command = 'sudo virsh shutdown ' + your_vm.name
	os.system(command)
...
def start(request):
	...
	command = 'sudo virsh start ' + your_vm.name
	os.system(command)
...
def delete(request):
	...
	try:
		subprocess.check_call(['ls','../../Tiramisu/tiramisu_src/delete_vm.py'])
	except:
		return HttpResponseRedirect("/tiramisu/servererror")
